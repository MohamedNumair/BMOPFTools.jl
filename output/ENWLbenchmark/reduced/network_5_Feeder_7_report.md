...
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_221' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
- **[E.SCHEMA.TYPE]** `[53]`  
  Type error at [bus][53][vpn_min]: got Float64, expected array.
...
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_221`  
  Generator 'der_221' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
