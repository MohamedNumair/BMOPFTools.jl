...
**Findings:** 1 errors · 1 warnings · 11 info  
...
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_183' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
**Total findings:** 13 (1 errors, 1 warnings, 11 info)
...
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_183`  
  Generator 'der_183' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
