...
**Findings:** 1 errors · 42 warnings · 65 info  
...
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_82' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_84' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
**Total findings:** 108 (1 errors, 42 warnings, 65 info)
...
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_82`  
  Generator 'der_82' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_84`  
  Generator 'der_84' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
