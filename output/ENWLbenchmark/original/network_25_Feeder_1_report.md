...
**Findings:** 1 errors · 86 warnings · 242 info  
...
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_252' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
> 🔵 **[I.SPEC.GEN_CONFIG_FUTURE]** Generator 'der_390' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
...
**Total findings:** 329 (1 errors, 86 warnings, 242 info)
...
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_252`  
  Generator 'der_252' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
- **[I.SPEC.GEN_CONFIG_FUTURE]** `der_390`  
  Generator 'der_390' configuration 'SINGLE_PHASE' is marked future-support in the spec (Table 4); only WYE is currently supported.
